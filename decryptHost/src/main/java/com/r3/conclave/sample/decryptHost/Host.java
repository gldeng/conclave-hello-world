package com.r3.conclave.sample.decryptHost;
 ...
 */
public class Host {
    private static void doDecryptFLow(String hexString) throws IOException, EnclaveLoadException {
        ...
        byte[] encrypted = UtilsKt.parseHex(hexString);
    ...
    public static void main(String[] args) throws EnclaveLoadException, IOException {
        ...
        String hexString = String.join(" ", args);

        reportPlatformSupport();
        doDecryptFLow(hexString);
    }
